...
{
    public partial class FrmReportServicios : MaterialSkin.Controls.MaterialForm
    {
        public FrmReportServicios()
        {
            InitializeComponent();
        }
        ...
        private void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            {    //ESCOJE A RUTA DONDE GUARDAREMOS EL PDF 
                ...
                if (save.ShowDialog() == DialogResult.OK)
                {
                    ...
                    Chunk encab3 = new Chunk("TIPO DE INFORMACION : Reportes de Servicios de  Mascota", FontFactory.GetFont("COURIER", 18));
