...
{
    public partial class FrmVacunas : MaterialSkin.Controls.MaterialForm
    {
        public FrmVacunas()
        {
            InitializeComponent();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                ClsEVacunas objESer = new ClsEVacunas();
                ClsNVacunas ojbjNSer = new ClsNVacunas();
                ...
                MessageBox.Show("Vacuna Agregado");
                MtdLimpiarCajas();
                ClsNVacunas objNcli = new ClsNVacunas();
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MessageBox.Show("Vacuna Modificado");
                MtdLimpiarCajas();
                ClsNVacunas ojbjNS = new ClsNVacunas();
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dtEmp.Rows.Count > 0)
                {
                    ...
                    txtNombres.Text = Fila["nombre"].ToString() + "," + Fila["apellido"].ToString();
        ...
        private void btnBuscarPorDni_Click(object sender, EventArgs e)
        {
            ...
            {
                ClsEVacunas objEC = new ClsEVacunas();
                ClsNVacunas ojbjNC = new ClsNVacunas();
