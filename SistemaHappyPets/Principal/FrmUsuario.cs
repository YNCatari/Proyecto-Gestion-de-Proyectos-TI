...
namespace SistemaVeterinaria.Principal
{
    public partial class FrmUsuario : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                ClsEUsuario objEemp = new ClsEUsuario();
                ClsNUsuario objNemp = new ClsNUsuario();
        ...
        private void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            {    //ESCOJE A RUTA DONDE GUARDAREMOS EL PDF 
                ...
                if (save.ShowDialog() == DialogResult.OK)
                {
                    ...
                    Chunk encab3 = new Chunk("TIPO DE INFORMACION : Reporte Usuarios", FontFactory.GetFont("COURIER", 18));
