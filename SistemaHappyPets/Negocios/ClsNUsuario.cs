...
namespace SistemaVeterinaria.Negocios
{
    class ClsNUsuario
    {
        ...
        public Boolean MtdAgregarMySql(ClsEUsuario clsCar)
        {
            try
            {
        ...
        public Boolean MtdMoficarMySql(ClsEUsuario clsCar)
        {
            try
            {
                ClsNConexion Objconexion = new ClsNConexion();
        ...
        public DataTable MtdBuscarMySql(ClsEUsuario clsCar)
        {
            ClsNConexion conn = new ClsNConexion();
            DataTable result = new DataTable();
            MySqlDataAdapter adapter = new MySqlDataAdapter();
        ...
        public DataTable MtdVAlidarLogin(ClsEUsuario clsCar)
        {
